...
const ProjectItem= ({img, title, tools}) => {
    return (
        <div className='items-center justify-center w-auto '>
            <div className=' relative flex items-center justify-center h-auto w-auto hover:shadow-xl shadow-none group hover:shadow-gray-400 rounded-2xl hover:bg-gradient-to-r from-gray-200 to-[#001b5e] transition-all duration-700 ease-in-out'>
